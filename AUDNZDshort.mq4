...
void OnTick()
   ...
   int b = 1000;
   int c = 300;
   //double WPR = iWPR(NULL,TimeFrame,225,0);
   //double WPR1 = iWPR(NULL,TimeFrame,225,4);
   ...
   //double MFI = iMFI(NULL,TimeFrame,15,0);
   ...
   double LotsToTrade = NormalizeDouble(((0.0000001)*AccountBalance()/(2*ATR)),2);
   double StopLoss = -(0.035*AccountBalance());
   double TakeProfit = (0.035*AccountBalance());
      ...
      if(ShortSetup == True)
        {
         ...
         int OrderResult = OrderSend(NULL, OP_SELL, LotsToTrade,Bid, 5,0,0, "Sell Order",Magic,0,clrGreen);
         ShortSetup = False;
